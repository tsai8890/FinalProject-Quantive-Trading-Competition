class Strategy():
    ...
    def __init__(self):
        ...
        self.last_last_cross_status = None
    ...
    def trade(self, information):
        ...
        if self.last_last_cross_status is None:
            self.last_last_cross_status = self.last_cross_status
        ...
        # 買爆
        if cur_cross == self.UP and self.last_cross_status == self.UP:
        ...
        # 賣爆
        elif cur_cross == self.DOWN and self.last_cross_status == self.DOWN:
            Log('buying, opt1:' + self['opt1'])
            self.last_type = 'buy'
            self.last_cross_status = cur_cross
            return [
